...
export class News extends Component {
  ...
  async updateNews() {
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=1967be5017434cf1b4539a01fd2303a4&page=${this.state.page}&pageSize=${this.props.pageSize}`;
